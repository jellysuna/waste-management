          ...
          children: [
            Stack(
              children: <Widget>[
                ...
                Padding(
                  padding:
                      const EdgeInsets.symmetric(horizontal: 26, vertical: 84),
                  child: Container(
                ...
                Padding(
                  padding: const EdgeInsets.only(
                      left: 30, right: 30, bottom: 8, top: 290),
                  child: Container(
                    height: 140,
                    width: 410,
                ...
                Padding(
                  padding: const EdgeInsets.only(left: 50, right: 60, top: 480),
                  child: Container(
                    alignment: Alignment.topLeft,
                    child: Column(
                        mainAxisAlignment: MainAxisAlignment.start,
                ...
                Padding(
                  padding: const EdgeInsets.only(left: 30, right: 30, top: 610),
                  child: Container(
                    height: 140,
                    width: 410,
                    decoration: BoxDecoration(
                ...
                Padding(
                  padding: const EdgeInsets.only(left: 50, right: 60, top: 650),
                  child: Container(
                    alignment: Alignment.topLeft,
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.start,
